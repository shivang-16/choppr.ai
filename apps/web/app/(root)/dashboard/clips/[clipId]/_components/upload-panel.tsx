...
export function UploadPanel({
  ...
  return (
    <div className="flex flex-col gap-3 min-h-0">
      ...
      <div className="flex w-full min-h-[40px] rounded-lg shadow-[0_4px_16px_rgba(124,58,237,0.35)]">
        <button
          type="button"
          onClick={openPicker}
          className="flex flex-1 items-center justify-center bg-[#7c3aed] hover:bg-[#6d28d9] active:bg-[#5b21b6] px-3 py-2.5 text-[13px] font-semibold leading-none text-white transition-colors cursor-pointer rounded-l-lg"
        >
          Import media
        </button>
        <button
          ...
          className="flex w-10 shrink-0 items-center justify-center border-l border-white/20 bg-[#7c3aed] hover:bg-[#6d28d9] active:bg-[#5b21b6] transition-colors cursor-pointer rounded-r-lg"
        >
