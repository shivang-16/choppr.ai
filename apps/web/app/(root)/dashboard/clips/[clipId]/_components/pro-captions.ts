 ...
 *
 * This file is duplicated verbatim in apps/api (src/services/pro-captions.ts)
 * apart from the `Ctx` type alias. Keep the two in sync.
 */

// The server copy widens this to `any` for SKRSContext2D from @napi-rs/canvas,
// which exposes the same surface.
