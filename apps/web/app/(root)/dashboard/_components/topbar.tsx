  ...
  return (
    <header className="fixed top-0 left-14 right-0 z-30 flex items-center justify-end gap-3 border-b border-white/6 bg-[#0a0a0a]/80 backdrop-blur-md px-6 h-12">
      ...
      <div className="flex items-center gap-1.5 rounded-lg border border-white/8 bg-white/5 px-3 py-1.5">
        ...
        <span className="text-[13px] font-semibold text-white">10</span>
      </div>

      {/* Add more credits */}
      <button className="rounded-lg border border-white/12 bg-white/8 px-3.5 py-1.5 text-[13px] font-medium text-white/70 hover:bg-white/12 hover:text-white transition-colors whitespace-nowrap">
        Add more credits
      </button>
    </header>
  );
